...
export default function Page() {
  ...
  const joystickPressed = useCallback((pressKeys: IJoystickBox.PressKey[], isStrength: boolean) => {
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowTop + ''] = false;
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowRight + ''] = false;
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowDown + ''] = false;
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowLeft + ''] = false;

    if (pressKeys.includes('ArrowUp')) {
      keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowTop + ''] = true;
    }
    if (pressKeys.includes('ArrowRight')) {
      keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowRight + ''] = true;
    }
    if (pressKeys.includes('ArrowDown')) {
      keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowDown + ''] = true;
    }
    if (pressKeys.includes('ArrowLeft')) {
      keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowLeft + ''] = true;
    }
  ...
  const joystickPressOut = useCallback(() => {
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowTop + ''] = false;
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowRight + ''] = false;
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowDown + ''] = false;
    keyPressedRef.current[characterControlsRef.current?.ControlKeys.ArrowLeft + ''] = false;
  ...
  const joystickJumpTab = useCallback(() => {
    if (characterControlsRef.current?.toggleJump) {
      return;
    }
  ...
  return (
    <>
      ...
      <JoystickBox
        __onPressed={joystickPressed}
        __onPressOut={joystickPressOut}
